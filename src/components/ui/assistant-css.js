...
export const assistantStyles = css`
    ...
    .text-input-container:focus-within {
        ...
        box-shadow: 0 8px 30px var(--black-alpha-40), 0 0 0 2px var(--primary-alpha-20);
    }
    ...
    .text-input-container.drag-over {
        ...
        box-shadow: 0 8px 30px rgba(59, 130, 246, 0.3), 0 0 0 2px rgba(59, 130, 246, 0.4) !important;
    }
